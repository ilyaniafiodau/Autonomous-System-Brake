...
execute_process(
  COMMAND "/usr/bin/git" show-ref "472aad2327fbfde827852fc44775904706847a3a"
  WORKING_DIRECTORY "/workspaces/asb/cmake_build/NUCLEO_F446RE/develop/GCC_ARM/_deps/greentea-client-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/asb/cmake_build/NUCLEO_F446RE/develop/GCC_ARM/_deps/greentea-client-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/asb/cmake_build/NUCLEO_F446RE/develop/GCC_ARM/_deps/greentea-client-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
